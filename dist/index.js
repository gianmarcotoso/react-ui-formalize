...
exports.getFormData = exports.Validate = exports.Transform = exports.Formalize = undefined;

var _Formalize = __webpack_require__(4);

var _Formalize2 = _interopRequireDefault(_Formalize);
...
var _getFormData = __webpack_require__(17);
...
// Import components
exports.Formalize = _Formalize2.default;
...
var _Formalize = __webpack_require__(5);

var _Formalize2 = _interopRequireDefault(_Formalize);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _Formalize2.default;
...
var Transform = function Transform(WrappedComponent) {
	var _class, _temp;
	...
	return _temp = _class = function (_Component) {
		...
		_createClass(_class, [{
			key: 'handleTransform',
			value: function handleTransform(data) {
				var _this2 = this;
				...
				var transformedData = Object.keys(data).reduce(function (result, property) {
					if (data.hasOwnProperty(property) && _this2.props.transformRules.hasOwnProperty(property)) {
						var transformFunction = _this2.props.transformRules[property];
			...
			key: 'render',
			value: function render() {
				return _react2.default.createElement(WrappedComponent, _extends({ ref: 'inner' }, this.props, { transform: this.handleTransform }));
			}
		}]);

		return _class;
	}(_react.Component), _class.propTypes = {
		transformRules: _propTypes.object
	}, _temp;
};
...
var Validate = function Validate(Validatable) {
	...
	return _temp = _class = function (_Component) {
		...
		_createClass(_class, [{
			...
			key: 'render',
			value: function render() {
				return _react2.default.createElement(Validatable, _extends({
					ref: 'inner'
				}, this.props, {
		...
		validationRules: _propTypes.object.isRequired,
		onValidationFail: _propTypes.func
	}, _temp;
};
...
var _getFormData = __webpack_require__(18);

var _getFormData2 = _interopRequireDefault(_getFormData);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _getFormData2.default;
